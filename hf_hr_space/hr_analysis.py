...
# =========================================================
# MODEL PATHS (relative to this file inside the HF Space)
# =========================================================
...
# =========================================================
def run_hr_video_analysis(video_path: str) -> dict:
    import mediapipe as mp
    import cv2
    ...
    frame_count = 0
    processed_frames = 0
    MAX_PROCESSED_FRAMES = 30  # HF Spaces has more RAM ceiling than Render free tier
